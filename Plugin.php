...
class TypechoTixing_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function config(Typecho_Widget_Helper_Form $form)
    {
        ...
        同时，关注后需要通过 <a href="https://www.phprm.com/push/h5/todo_create.html">口令提醒</a> 点击图标创建一个口令提醒, 然后“复制网址”粘贴到这里'));
    ...
    public static function sc_send($comment, $post)
    {
        ...
        $desp = date('H:i:s', $comment['created'] + $options->timezone)."  ".$comment['text'];
